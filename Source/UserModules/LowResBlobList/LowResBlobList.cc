//
//	LowResBlobList.cc	This file is a part of the IKAROS project
...
static InitClass init("LowResBlobList", &LowResBlobList::Create, "Source/UserModules/LowResBlobList/");
